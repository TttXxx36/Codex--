...
import { t } from "@/i18n";
import { formatTime, Panel } from "./ScreenPrimitives";
import type {
  Actions,
  BackendSettings,
  LocalSession,
  WeixinConnectStatusResult,
  WeixinQrResult,
} from "../App";
...
export const WeixinConnectScreen = memo(function WeixinConnectScreen({
  form,
  status,
  qr,
  sessions,
...
export default WeixinConnectScreen;
